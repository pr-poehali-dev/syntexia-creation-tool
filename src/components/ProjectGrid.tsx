...
const ProjectGrid = ({
  ...
  const handleSceneClick = (scene: Scene, plotLine: PlotLine) => {
                      ...
                      <div key={chapter.id} className="w-48 flex-shrink-0 px-2">
                        <div className="space-y-2">
                          {chapterScenes.map((scene) => (
                            <div
                              key={scene.id}
                              onClick={() => handleSceneClick(scene, plotLine)}
                            ...
                            >
                              ...
                              <button
                                ...
                                className="absolute -top-2 -right-2 hidden group-hover:flex items-center justify-center w-5 h-5 bg-red-600 rounded-full text-xs z-10"
                              >
                                ×
                              </button>
                            </div>
